...
3. We are making PUT and GET requests to spectre3d API and using photogrammetry and machine learning with Spectre3d to convert it into a 3D mesh. For the time being, we are storing the 3D image data on IPFS and later render it back from IPFS to the Discover section of EONIA webpage.
